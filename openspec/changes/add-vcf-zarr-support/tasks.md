...
- [x] 3.2 Run upstream Rust tests for the affected `datafusion-bio-formats` crate(s).
- [x] 3.3 Run polars-bio Rust checks/tests.
- [x] 3.4 Run targeted polars-bio VCF Zarr pytest tests.
- [x] 3.5 Run `openspec validate add-vcf-zarr-support --strict`.
