...
impl RangeOptions {
    ...
    #[new]
    #[pyo3(signature = (range_op, filter_op=None, suffixes=None, columns_1=None, columns_2=None, on_cols=None, overlap_alg=None, overlap_low_memory=None, nearest_k=None, include_overlaps=None, compute_distance=None, min_dist=None, view_table=None, view_columns=None, overlap_output=None))]
    pub fn new(
        range_op: RangeOp,
