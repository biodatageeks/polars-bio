...
/// Extract FORMAT field names from multisample `genotypes` schema.
///
/// Supports two shapes:
/// - New: `Struct<GT: List, DP: List, ...>` — field names are FORMAT ids directly
/// - Legacy: `List<Struct<sample_id, values: Struct<GT, DP, ...>>>` — FORMAT ids inside `values`
...
fn apply_vcf_metadata_to_schema(
    ...
    for field in schema.fields() {
        ...
        // Handle multisample genotypes schema — attach FORMAT metadata to fields.
        // Supports two shapes:
